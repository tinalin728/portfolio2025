  ...
  return (
    ...
    >
      <div className="flex justify-center items-center gap-3">
        <Mail
          className="text-greyscale-300 dark:text-greyscale-200 w-[18px] h-[18px]"
          strokeWidth={2}
        />
        <p className="font-normal text-greyscale-300  [html.dark_&]:text-greyscale-200 tracking-[.8px] uppercase font-inter text-[12.5px]">
          contact@tinalin.ca
        </p>
      </div>
      ...
      >
        <Copy
          className="dark:text-white-100 w-[18px] h-[18px]"
          strokeWidth={2}
        />
